...
instance ColorFormat RGFloatFormat where
    ...
    typePrefix _ = ' '    
    toColor _ (r,g,_,_) = RG r g
    fromColor _ (RG r g) x = (r,g,x,x)
...
instance ColorFormat RGBFloatFormat where
    ...
    typePrefix _ = ' '    
    toColor _ (r,g,b,_) = RGB r g b
    fromColor _ (RGB r g b) x = (r,g,b,x)
...
instance ColorFormat RGBAFloatFormat where
    ...
    fromColor _ (RGBA r g b a) _ = (r,g,b,a)
